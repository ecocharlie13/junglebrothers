  ...
  constructor(selector, tarefas, periodo = "Tudo") {
    ...
    cultivos.forEach(c => {
      ...
      item.addEventListener("click", () => {
        document.querySelectorAll(`[data-cultivo="${c}"]`).forEach(el => {
    ...
    // Cabeçalho Mes/Semana
    const cabecalho = document.createElement("div");
    cabecalho.className = "flex text-xs font-bold text-gray-700 mb-2 w-full";
    for (let i = 0; i < semanas; i++) {
      ...
      coluna.innerHTML = `<div class="text-orange-500 text-xs">${mes}</div><div>S${semana}</div>`;
    ...
    tarefas.forEach(t => {
      ...
      linha.dataset.cultivo = t.cultivo;
